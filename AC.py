...
EPSILON = 0.3 # constant epsilon policy to encourage exploration
EXPLORATION_FACTOR = 0.4 # # multiply the policy output of the network by an exploration factor (0.2) before softmax
ENTROPY_BETA = 0.1 # discount factor for entropy
ENTROPY_CONSTANT = 1e-5 # to avoid taking log on zero probabilities, 1e-10
